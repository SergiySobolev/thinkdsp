...
from com.sbk.signal.triangle.sbk_triangle_signal import SbkTriangleSignal


class SbkTestTriangleSignal(unittest.TestCase):

    def setUp(self):
        self.test_freq = 200
        self.test_duration = 0.05
        self.test_frame_rate = 10000
        self.triangle_signal = SbkTriangleSignal(freq=self.test_freq)
