...
from com.sbk.func.convolve.convolve import convolve_machine


class TestConvolveMachine(unittest.TestCase):
    ...
    def test_convolve_with_delta_function(self):
        ...
        npt.assert_array_equal(signal,
                               np.trim_zeros(convolve_machine(signal, impulse_response), trim="b"))
    ...
    def test_convolve_with_shift_function(self):
        ...
        npt.assert_array_equal(res, convolve_machine(signal, impulse_response))
